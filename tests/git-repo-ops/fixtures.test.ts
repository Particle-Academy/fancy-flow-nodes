...
import { gitStatusKind } from "../../nodes/git-status/ui/kind";
import { gitStatusExecutor } from "../../nodes/git-status/js/executor";
import { registerGitRepoHost as registerStatusHost } from "../../nodes/git-status/js/repo";

import { gitLogKind } from "../../nodes/git-log/ui/kind";
import { gitLogExecutor } from "../../nodes/git-log/js/executor";
import { registerGitRepoHost as registerLogHost } from "../../nodes/git-log/js/repo";

import { gitBranchesKind } from "../../nodes/git-branches/ui/kind";
import { gitBranchesExecutor } from "../../nodes/git-branches/js/executor";
import { registerGitRepoHost as registerBranchesHost } from "../../nodes/git-branches/js/repo";

import { gitDiffKind } from "../../nodes/git-diff/ui/kind";
import { gitDiffExecutor } from "../../nodes/git-diff/js/executor";
import { registerGitRepoHost as registerDiffHost } from "../../nodes/git-diff/js/repo";

import { gitCheckoutKind } from "../../nodes/git-checkout/ui/kind";
import { gitCheckoutExecutor } from "../../nodes/git-checkout/js/executor";
import { registerGitRepoHost as registerCheckoutHost } from "../../nodes/git-checkout/js/repo";

import { gitPushKind } from "../../nodes/git-push/ui/kind";
import { gitPushExecutor } from "../../nodes/git-push/js/executor";
import { registerGitRepoHost as registerPushHost } from "../../nodes/git-push/js/repo";

import { gitPullKind } from "../../nodes/git-pull/ui/kind";
import { gitPullExecutor } from "../../nodes/git-pull/js/executor";
import { registerGitRepoHost as registerPullHost } from "../../nodes/git-pull/js/repo";
...
describe.each(NODES)("$dir", ({ dir, kind, executor, register }) => {
  ...
  const manifest = JSON.parse(
    readFileSync(resolve(process.cwd(), "nodes", dir, "fancy-flow.node.json"), "utf8"),
  );
  const file = JSON.parse(readFileSync(resolve(process.cwd(), manifest.fixtures), "utf8")) as FixtureFile;
