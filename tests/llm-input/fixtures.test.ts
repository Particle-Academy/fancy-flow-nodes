...
import { llmInputKind } from "../../nodes/llm-input/ui/kind";
import { llmInputExecutor } from "../../nodes/llm-input/js/executor";
import { registerLlmFormHost } from "../../nodes/llm-input/js/host";
import type { LlmFormRequest, LlmFormResult } from "../../nodes/llm-input/js/types";
...
const manifest = JSON.parse(
  readFileSync(resolve(process.cwd(), "nodes/llm-input/fancy-flow.node.json"), "utf8"),
