...
import { gitIssueOpenKind } from "../../nodes/git-issue-open/ui/kind";
import { gitIssueOpenExecutor } from "../../nodes/git-issue-open/js/executor";
import { registerGitHost as registerOpenHost } from "../../nodes/git-issue-open/js/provider";

import { gitIssueGetKind } from "../../nodes/git-issue-get/ui/kind";
import { gitIssueGetExecutor } from "../../nodes/git-issue-get/js/executor";
import { registerGitHost as registerGetHost } from "../../nodes/git-issue-get/js/provider";

import { gitIssueListKind } from "../../nodes/git-issue-list/ui/kind";
import { gitIssueListExecutor } from "../../nodes/git-issue-list/js/executor";
import { registerGitHost as registerListHost } from "../../nodes/git-issue-list/js/provider";

import { gitIssueUpdateKind } from "../../nodes/git-issue-update/ui/kind";
import { gitIssueUpdateExecutor } from "../../nodes/git-issue-update/js/executor";
import { registerGitHost as registerUpdateHost } from "../../nodes/git-issue-update/js/provider";

import { gitIssueCommentKind } from "../../nodes/git-issue-comment/ui/kind";
import { gitIssueCommentExecutor } from "../../nodes/git-issue-comment/js/executor";
import { registerGitHost as registerCommentHost } from "../../nodes/git-issue-comment/js/provider";
