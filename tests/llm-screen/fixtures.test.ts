...
import { llmScreenKind } from "../../nodes/llm-screen/ui/kind";
import { llmScreenExecutor } from "../../nodes/llm-screen/js/executor";
import { registerLlmScreenHost } from "../../nodes/llm-screen/js/host";
import { checkSchema } from "../../nodes/llm-screen/js/schema";
import type { LlmScreenResult, ScreenSchema } from "../../nodes/llm-screen/js/types";
...
const manifest = JSON.parse(
  readFileSync(resolve(process.cwd(), "nodes/llm-screen/fancy-flow.node.json"), "utf8"),
