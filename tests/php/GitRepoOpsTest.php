...
dataset('repo nodes', [
    'git-status' => ['git-status', \FancyFlow\Nodes\GitStatus\GitStatusExecutor::class, \FancyFlow\Nodes\GitStatus\RepoHost::class],
    'git-log' => ['git-log', \FancyFlow\Nodes\GitLog\GitLogExecutor::class, \FancyFlow\Nodes\GitLog\RepoHost::class],
    'git-branches' => ['git-branches', \FancyFlow\Nodes\GitBranches\GitBranchesExecutor::class, \FancyFlow\Nodes\GitBranches\RepoHost::class],
    'git-diff' => ['git-diff', \FancyFlow\Nodes\GitDiff\GitDiffExecutor::class, \FancyFlow\Nodes\GitDiff\RepoHost::class],
    'git-checkout' => ['git-checkout', \FancyFlow\Nodes\GitCheckout\GitCheckoutExecutor::class, \FancyFlow\Nodes\GitCheckout\RepoHost::class],
    'git-push' => ['git-push', \FancyFlow\Nodes\GitPush\GitPushExecutor::class, \FancyFlow\Nodes\GitPush\RepoHost::class],
    'git-pull' => ['git-pull', \FancyFlow\Nodes\GitPull\GitPullExecutor::class, \FancyFlow\Nodes\GitPull\RepoHost::class],
]);

it('runs every golden fixture the TypeScript backend runs', function (string $dir, string $executorClass, string $hostClass) {
    $manifest = json_decode((string) file_get_contents(__DIR__."/../../nodes/{$dir}/fancy-flow.node.json"), true);
    $file = json_decode((string) file_get_contents(__DIR__.'/../../'.$manifest['fixtures']), true);
...
it('performs the operation when not proposing', function () {
    ...
    $executor = new \FancyFlow\Nodes\GitPush\GitPushExecutor(
...
it('refuses to guess a checkout target', function () {
    $executor = new \FancyFlow\Nodes\GitCheckout\GitCheckoutExecutor(
