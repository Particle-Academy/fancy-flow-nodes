...
{
    return new class implements \FancyGit\Provider\IssueProvider
    {
...
dataset('issue nodes', [
    'git-issue-open' => ['git-issue-open', \FancyFlow\Nodes\GitIssueOpen\GitIssueOpenExecutor::class, \FancyFlow\Nodes\GitIssueOpen\GitHost::class],
    'git-issue-get' => ['git-issue-get', \FancyFlow\Nodes\GitIssueGet\GitIssueGetExecutor::class, \FancyFlow\Nodes\GitIssueGet\GitHost::class],
    'git-issue-list' => ['git-issue-list', \FancyFlow\Nodes\GitIssueList\GitIssueListExecutor::class, \FancyFlow\Nodes\GitIssueList\GitHost::class],
    'git-issue-update' => ['git-issue-update', \FancyFlow\Nodes\GitIssueUpdate\GitIssueUpdateExecutor::class, \FancyFlow\Nodes\GitIssueUpdate\GitHost::class],
    'git-issue-comment' => ['git-issue-comment', \FancyFlow\Nodes\GitIssueComment\GitIssueCommentExecutor::class, \FancyFlow\Nodes\GitIssueComment\GitHost::class],
]);
